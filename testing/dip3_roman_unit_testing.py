...
class ToRomanBadInputs(unittest.TestCase):
    def test_too_large(self):
        self.assertRaises(roman.OutOfRangeError, roman.to_roman, 4000)
        self.assertRaises(roman.OutOfRangeError, roman.to_roman, 999000)
    ...
    def test_non_integer(self):
        self.assertRaises(roman.NotIntegerError, roman.to_roman, 1.1)
        self.assertRaises(roman.NotIntegerError, roman.to_roman, 100.0)
